...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/ext-regex
   cd ext-regex
   ```
...
```sh
https://github.com/flex-development/ext-regex/compare/main...$branch
```
...
[19]: https://github.com/flex-development/ext-regex/discussions/new?category=q-a
